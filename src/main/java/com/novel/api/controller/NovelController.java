...
public class NovelController {
     ...
     */
    @GetMapping("/{novelId}")
    public GetNovelResponse get(Long novelId){
     ...
     */
    @PostMapping("")
    public void signup(@RequestBody PostNovelRequest request, Authentication authentication) {
     ...
     */
    @PutMapping("/{novelId}")
    public void edit(Long novelId, @RequestBody PutNovelRequest request, Authentication authentication){
        String name = authentication.getName();
    ...
    public void delete(Long novelId, Authentication authentication) {
        String name = authentication.getName();
     ...
     */
    @GetMapping("")
    public PageingResponse<GetNovelListResponse> getList(GetNovelListSearch getNovelListSearch){
